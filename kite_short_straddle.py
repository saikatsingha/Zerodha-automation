...
# def get_kite():
#     kiteObj = KiteConnect(api_key='msedx0q2eynocr2r')
#     kiteObj.set_access_token('GjjZbY6ddvJGYSPnL5g2TRlqwAHsetBZ')
#     return kiteObj

kite = KiteConnect(api_key="msedx0q2eynocr2r")
kite.set_access_token("m8D4Oy5MmfN8Fq5jZ5MzG669tE7ToHoZ")
print(kite)

# WNSE3AFIW7B5OGOUCMTLC4GJ4YAAT4QB
